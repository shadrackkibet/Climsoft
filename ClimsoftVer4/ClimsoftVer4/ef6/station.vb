...
Partial Public Class station
    ...
    Public Overridable Property instrumentfaultreport As ICollection(Of instrumentfaultreport) = New HashSet(Of instrumentfaultreport)
    Public Overridable Property obsscheduleclass As ICollection(Of obsscheduleclass) = New HashSet(Of obsscheduleclass)
    Public Overridable Property physicalfeatureclass As ICollection(Of physicalfeatureclass) = New HashSet(Of physicalfeatureclass)
